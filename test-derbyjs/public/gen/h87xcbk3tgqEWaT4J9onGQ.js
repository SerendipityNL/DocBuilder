...
require.define("/node_modules/derby/node_modules/racer/lib/middleware.js",Function(['require','module','exports','__dirname','__filename','process','global'],"module.exports = function () {\n  var fns = [];\n  function run (req, res, done) {\n    var i = 0, out;\n    function next () {\n      var fn = fns[i++];\n      return fn ? (out = fn(req, res, next))\n                : done ? done() : out;\n    }\n    return next();\n  }\n\n  run.add = function (fn) {\n    fns.push(fn);\n    return this;\n  };\n\n  return run;\n};\n\n//@ sourceURL=/node_modules/derby/node_modules/racer/lib/middleware.js"
));
...
view._makeAll({
  "app/index.html:body": "<h1>{_room.welcome}</h1><p><label>Welcome message: <input value=\"{_room.welcome}\"></label></p><p>This page has been visited {_room.visits} times. <app:timer></p><p>Let's go <a href=\"/{{randomUrl}}\">somewhere random</a>.</p>",
  "app/index.html:header": "<ui:connectionAlert>",
